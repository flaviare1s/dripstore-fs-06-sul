...
export const BurgerMenu = () => {
  ...
  return (
    <>
      {burgerMenuState.isActiveBurgerMenu && <div className="h-full flex flex-col bg-white w-4/5 p-7 grow justify-between md:hidden transition-[width] ease-in-out delay-150">
