  ...
  return (
    <div className='font-Inter w-screem flex flex-col md:flex-row-reverse justify-center items-center px-5 md:pt-[78px] md:pl-[100px] md:pr-[37px]'>
      ...
      <div className='flex flex-col items-center md:items-start md:w-[38%]'>
        ...
        <a href={ctaLink} className='bg-[#C92071] text-[#F5F5F5] text-base text-center p-3 font-bold leading-6 w-full h-12 mb-10 md:w-[220px] rounded-md mt-10 tracking-[.75px]'>{ctaText}</a>
      </div>
    </div>
  )
}
